...
import java.util.*;
//https://github.com/ontio/ontology-java-sdk/blob/master/src/main/java/demo/PunicaInitDemo.java
...
//        ontSdk.addMultiSign(tx,2,new byte[][]{account.serializePublicKey(),account2.serializePublicKey()},account2);
    ...
    public static OntSdk getOntSdk() throws Exception{
        ...
        wm.neovm().oep4().setContractAddress("30620a9f8681a584f8180aa809136a2683e6cdd1");
