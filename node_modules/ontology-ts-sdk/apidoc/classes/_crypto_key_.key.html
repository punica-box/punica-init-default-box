...
<head>
	...
	<title>Key | ontology-ts-sdk</title>
	...
	<div class="tsd-page-title">
		<div class="container">
			<ul class="tsd-breadcrumb">
				...
				<li>
					<a href="_crypto_key_.key.html">Key</a>
				</li>
			</ul>
			<h1>Class Key</h1>
		</div>
		...
		<div class="col-8 col-content">
			<section class="tsd-panel tsd-comment">
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Common representation of private or public key</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-hierarchy">
				...
				<ul class="tsd-hierarchy">
					<li>
						...
						<ul class="tsd-hierarchy">
							<li>
								<a href="_crypto_publickey_.publickey.html" class="tsd-signature-type">PublicKey</a>
							</li>
							<li>
								<a href="_crypto_privatekey_.privatekey.html" class="tsd-signature-type">PrivateKey</a>
							</li>
						</ul>
					</li>
				</ul>
					...
					<div class="tsd-index-content">
						<section class="tsd-index-section ">
							...
							<ul class="tsd-index-list">
								<li class="tsd-kind-constructor tsd-parent-kind-class"><a href="_crypto_key_.key.html#constructor" class="tsd-kind-icon">constructor</a></li>
							</ul>
						</section>
						<section class="tsd-index-section ">
							<h3>Properties</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-property tsd-parent-kind-class"><a href="_crypto_key_.key.html#algorithm" class="tsd-kind-icon">algorithm</a></li>
								<li class="tsd-kind-property tsd-parent-kind-class"><a href="_crypto_key_.key.html#key" class="tsd-kind-icon">key</a></li>
								<li class="tsd-kind-property tsd-parent-kind-class"><a href="_crypto_key_.key.html#parameters" class="tsd-kind-icon">parameters</a></li>
							</ul>
						</section>
						<section class="tsd-index-section ">
							<h3>Methods</h3>
							<ul class="tsd-index-list">
								<li class="tsd-kind-method tsd-parent-kind-class"><a href="_crypto_key_.key.html#computehash" class="tsd-kind-icon">compute<wbr>Hash</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class"><a href="_crypto_key_.key.html#isschemasupported" class="tsd-kind-icon">is<wbr>Schema<wbr>Supported</a></li>
								<li class="tsd-kind-method tsd-parent-kind-class"><a href="_crypto_key_.key.html#serializejson" class="tsd-kind-icon">serialize<wbr>Json</a></li>
							</ul>
						</section>
					</div>
				</section>
			...
			<section class="tsd-panel-group tsd-member-group ">
				...
				<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class">
					...
					<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class">
						<li class="tsd-signature tsd-kind-icon">new <wbr>Key<span class="tsd-signature-symbol">(</span>key<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, algorithm<span class="tsd-signature-symbol">?: </span><a href="_crypto_keytype_.keytype.html" class="tsd-signature-type">KeyType</a>, parameters<span class="tsd-signature-symbol">?: </span><a href="_crypto_key_.keyparameters.html" class="tsd-signature-type">KeyParameters</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="_crypto_key_.key.html" class="tsd-signature-type">Key</a></li>
					</ul>
					<ul class="tsd-descriptions">
						<li class="tsd-description">
							...
							<h4 class="tsd-returns-title">Returns <a href="_crypto_key_.key.html" class="tsd-signature-type">Key</a></h4>
						</li>
					</ul>
				</section>
			</section>
					...
					<li class="current tsd-kind-class tsd-parent-kind-external-module">
						...
						<ul>
							<li class=" tsd-kind-constructor tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#constructor" class="tsd-kind-icon">constructor</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#algorithm" class="tsd-kind-icon">algorithm</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#key" class="tsd-kind-icon">key</a>
							</li>
							<li class=" tsd-kind-property tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#parameters" class="tsd-kind-icon">parameters</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#computehash" class="tsd-kind-icon">compute<wbr>Hash</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#isschemasupported" class="tsd-kind-icon">is<wbr>Schema<wbr>Supported</a>
							</li>
							<li class=" tsd-kind-method tsd-parent-kind-class">
								<a href="_crypto_key_.key.html#serializejson" class="tsd-kind-icon">serialize<wbr>Json</a>
							</li>
						</ul>
					</li>
				</ul>
